...
exports.toVarReference = exports.toVarDefinition = exports.cssVar = exports.addPrefix = void 0;
/**
 ...
 */
var addPrefix = exports.addPrefix = function addPrefix(value, prefix) {
  if (prefix === void 0) {
    prefix = '';
  }
 ...
 */
var toVarReference = exports.toVarReference = function toVarReference(name, fallback) {
 ...
 */
var toVarDefinition = exports.toVarDefinition = function toVarDefinition(value, prefix) {
  if (prefix === void 0) {
    prefix = '';
  }
 ...
 */
var cssVar = exports.cssVar = function cssVar(name, fallback, cssVarPrefix) {
